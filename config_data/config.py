...
class TgBot:
    ...
    Attributes:
        token (str): The token used to authenticate
        the bot with the Telegram API.
    """
...
class Config:
    ...
    Attributes:
        tg_bot (TgBot): An instance of the TgBot dataclass
        containing the bot's configuration.
    """
...
def load_config(path: str | None = None) -> Config:
    ...
    Args:
        path (str | None): The path to the .env file.
